        ...
        for model_name in self.models_average_metrics_dct.keys():
            ...
            for sensitive_attr in self.sensitive_attributes_dct.keys():
                ...
                groups_metrics_dct[sensitive_attr] = {
                    ...
                    'Overall_Uncertainty_Ratio': cfm[dis_group]['Overall_Uncertainty'] / cfm[priv_group]['Overall_Uncertainty'],
                    'Aleatoric_Uncertainty_Parity': cfm[dis_group]['Aleatoric_Uncertainty'] - cfm[priv_group]['Aleatoric_Uncertainty'],
                    'Aleatoric_Uncertainty_Ratio': cfm[dis_group]['Aleatoric_Uncertainty'] / cfm[priv_group]['Aleatoric_Uncertainty'],
                }
