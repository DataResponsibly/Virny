...
from virny.utils.postprocessing_intervention_utils import contruct_binary_label_dataset, predict_on_binary_label_dataset
...
class BatchOverallVarianceAnalyzerPostProcessing(BatchOverallVarianceAnalyzer):
    def __init__(self, postprocessor, sensitive_attribute: str, 
        ...
        self.test_binary_label_dataset = contruct_binary_label_dataset(X_test, y_test, target_column, sensitive_attribute)
    ...
    def UQ_by_boostrap(self, boostrap_size: int, with_replacement: bool, with_fit: bool = True) -> dict:
        ...
        for idx in cycle_range:
            ...
            train_binary_label_dataset_sample = contruct_binary_label_dataset(X_sample, y_sample, self.target_column, self.sensitive_attribute)
